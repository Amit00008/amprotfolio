...
import loginsignup from "../../assets/ls.png";
import "./projects.css";
import moodify from "../../assets/moodify.png";
const Chat_app = ({ title, main }) => {
  return (
    <div class="card">
      <div class="card__img">
        <img src={chatapp} alt="" />
      ...
      <div class="card__descr-wrapper">
        ...
        <div class="card__links">
          ...
          <div>
            ...
            <a class="link" href="https://github.com/Amit00008/Chatapp">
              Code
            </a>
          </div>
        </div>
      ...
      <div class="card__descr-wrapper">
        ...
        <div class="card__links">
          ...
          <div>
            ...
            <a
              class="link"
              href="https://github.com/Amit00008/LoginSignup-using-Reactjs"
            >
              Code
            </a>
          </div>
      ...
      <div class="card__descr-wrapper">
        ...
        <div class="card__links">
          ...
          <div>
            ...
            <a class="link" href="https://github.com/Amit00008/MoodiFy">
              Code
            </a>
          </div>
        </div>
...
const File_share = ({ title, main }) => {
  return (
    <div class="card">
      <div class="card__img">
        <img src={fileshare} alt="" />
      </div>
      <div class="card__descr-wrapper">
        <p class="card__title">{title}</p>
        <p class="card__descr">{main}</p>
        <div class="card__links">
          <div>
            ...
            <a class="link" href="https://file-share-8ryy.onrender.com/">
              Preview
            </a>
          </div>
          <div>
            ...
            <a class="link" href="https://github.com/Amit00008/file-share">
              Code
            </a>
          </div>
        </div>
...
const Test = ({ title, main }) => {
  return (
    <div class="card">
      <div class="card__img">
        <img
          src="https://cdn.dribbble.com/users/2216228/screenshots/8813462/media/175424f94e55061b97f04a1a4de77440.jpg"
          alt=""
        />
      </div>
      <div class="card__descr-wrapper">
        ...
        <div class="card__links">
          <div>
            ...
            <a class="link" href="https://github.com/Amit00008">
              Check my Github
            </a>
          </div>
        </div>
...
export { Chat_app, Login_signup, Moodi_fy, File_share, Test };
